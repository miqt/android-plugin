...
public class JSONTokener {
     ...
     *
     * @return a {@link com.miqt.strmixlib.json.JSONObject}, {@link com.miqt.strmixlib.json.JSONArray}, String, Boolean,
     *     Integer, Long, Double or {@link com.miqt.strmixlib.json.JSONObject#NULL}.
     * @throws com.miqt.strmixlib.json.JSONException if the input is malformed.
     */
    public Object nextValue() throws com.miqt.strmixlib.json.JSONException {
    ...
    private int nextCleanInternal() throws com.miqt.strmixlib.json.JSONException {
        while (pos < in.length()) {
            int c = in.charAt(pos++);
            switch (c) {
                case '\t':
     ...
     */
    public String nextString(char quote) throws com.miqt.strmixlib.json.JSONException {
        /*
    ...
    private char readEscapeCharacter() throws com.miqt.strmixlib.json.JSONException {
    ...
    private Object readLiteral() throws com.miqt.strmixlib.json.JSONException {
        String literal = nextToInternal("{}[]/\\:,=;# \t\f");

        if (literal.length() == 0) {
            throw syntaxError("Expected literal value");
        } else if ("null".equalsIgnoreCase(literal)) {
            return com.miqt.strmixlib.json.JSONObject.NULL;
    ...
    private com.miqt.strmixlib.json.JSONObject readObject() throws com.miqt.strmixlib.json.JSONException {
    ...
    private com.miqt.strmixlib.json.JSONArray readArray() throws com.miqt.strmixlib.json.JSONException {
        com.miqt.strmixlib.json.JSONArray result = new JSONArray();
     ...
     */
    public com.miqt.strmixlib.json.JSONException syntaxError(String message) {
        return new com.miqt.strmixlib.json.JSONException(message + this);
    }
     ...
     * exception is thrown.
     */
    public char next(char c) throws com.miqt.strmixlib.json.JSONException {
        char result = next();
        if (result != c) {
     ...
     */
    public char nextClean() throws com.miqt.strmixlib.json.JSONException {
     ...
     *
     * @throws com.miqt.strmixlib.json.JSONException if the remaining input is not long enough to
